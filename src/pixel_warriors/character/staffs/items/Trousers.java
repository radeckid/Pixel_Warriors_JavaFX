...
public class Trousers extends ItemBody <Trousers>
{
    ...
    {
        super(idItem, name, path, ItemType.Trousers, pathBody);
    ...
    {
        super(armor.getIdItem(), armor.getName(), armor.getPath(), ItemType.Trousers, armor.getPathBody());
